...
const PUBLIC_FIELDS=['id','fileName','session','species','scientificName','reviewStatus','confidence','rating','ratingSource','capturedAt','importedAt','metadata','width','height','analyzed'];
